...
$(".depto-material").hover(()=>{
    
    $(".depto-material#material").show()
}, 
()=>{
    $(".depto-material#material").hide()
})
$(".depto-prevencao").hover(()=>{
    
    $(".depto-prevencao#prevencao").show()
}, 
()=>{
    $(".depto-prevencao#prevencao").hide()
})
