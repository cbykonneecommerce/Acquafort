...
$(document).ready(function() {
    ...
    setTimeout(()=>{
        $('.product-details .price-box .descricao-preco .valor-por').prepend('<div style="margin-bottom:10px;margin-top:16px"><img src="/arquivos/avista.png" id="avista" style="width:28px;margin-top:-15px" /><p style="color:#A7A7A7; display:inline; font-size:16px"> Pague à vista</p></div>');
